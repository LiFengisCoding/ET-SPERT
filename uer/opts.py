...
def finetune_opts(parser):
    ...
    parser.add_argument("--output_model_path", default="D:/PyCharm/Code/ET-BERT-main/models/finetuned_model.bin", type=str,
    ...
    parser.add_argument("--config_path", default="D:/PyCharm/Code/ET-BERT-main/models/bert/base_config.json", type=str,
